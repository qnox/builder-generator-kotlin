...
class BuilderGenerator {
    ...
    private fun addBuilderProperty(
        ...
        classBuilder.addProperty(
            PropertySpec
                .builder(property.name, type, KModifier.PRIVATE)
                .initializer(
                    "%T(%S, %L)",
                    type,
                    property.name,
    ...
    private fun builderPropertyType(context: ProcessorContext, propertyType: KSTypeReference) =
